...
const MyAccount: React.FC = () => {
  ...
  const fetchRecentActivity = async () => {
    try {
      ...
      const depositActivities: Activity[] = Array.isArray(deposits) 
      ...
      const withdrawalActivities: Activity[] = Array.isArray(withdrawals)
      ...
      const combinedActivities = [...depositActivities, ...withdrawalActivities]
        .sort(
          (a, b) =>
