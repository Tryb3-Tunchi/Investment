...
class ApiService {
    ...
    // UPDATED: Balance Methods to handle the actual API response format
    ...
    // Deposits Methods - Improved to handle pagination response format
    ...
    // Withdrawals Methods - Improved to handle pagination response format
